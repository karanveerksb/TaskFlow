...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_columnId_boardId_fkey" FOREIGN KEY ("columnId", "boardId") REFERENCES "Column"("id", "boardId") ON DELETE CASCADE ON UPDATE CASCADE;
